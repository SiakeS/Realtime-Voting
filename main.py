...
def generate_voter_data():
    ...
    if response.status_code == 200:
        ...
        return {
            ...
            'regisatration_number': user_data['login']['username'],
            'address': {
                'street': f"{user_data['location']['street']['number']} {user_data['location']['street']['name']}",
                'city': f"{user_data['location']['city']}",
                'state': f"{user_data['location']['state']}",
                'country': f"{user_data['location']['country']}",
                'postcode': f"{user_data['location']['postcode']}"
                },
...
def insert_voters(conn, cur, voter):
    ...
    """, (
        voter['voter_id'], voter['voter_name'], voter['date_of_birth'], voter['gender'], voter['nationality'], voter['regisatration_number'], voter['address']['street'],
        voter['address']['city'], voter['address']['state'], voter['address']['country'], voter['address']['postcode'], voter['email'], voter['phone_number'], voter['picture'], voter['registered_age']
        ))
