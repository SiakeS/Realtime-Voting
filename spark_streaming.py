...
if __name__ == '__main__':
    spark = (SparkSession.builder
             ...
             .config('spark.jars', 
                     '/Users/siakesophie/Local_Docs/Data Projects/Real_Time_Voting/postgresql-42.7.4.jar')
    ...
    vote_schema = StructType([
        ...
        StructField('regisatration_number', StringType(), True),
...
votes_per_candidate_to_kafka = (votes_per_candidate.selectExpr('to_json(struct(*)) As value')
                                    ...
                                    .option('checkpointLocation', '/Users/siakesophie/Local_Docs/Data Projects/Real_Time_Voting/checkpoints/checkpoint1')
                                    .outputMode('update')
                                    .start()
                                    )
...
turnout_by_location_to_kafka = (turnout_by_location.selectExpr('to_json(struct(*)) As value')
                                    ...
                                    .option('checkpointLocation', '/Users/siakesophie/Local_Docs/Data Projects/Real_Time_Voting/checkpoints/checkpoint2')
                                    .outputMode('update')
                                    .start()
                                    )
